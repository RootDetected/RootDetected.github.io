info="<b>Device: Xiaomi Redmi Note 9</b><br><b>Kernel: 4.14</b><br><b>ReZygisk v1.0.0-437-3c9e94a</b><br><b>Treat Wheel v0.0.7</b><br>";

title="Comparison - Meow Detector Native - 18/Dec/2025";

columns=["Package","ROM: MIUI V13.0.2.0.SJOMIXM\nAndroid: 12\nMagisk: Alpha 30600","ROM: AxionOS v2.2.1\nAndroid: 16\nKernelSU Next (Driver 32334)\n(Manager v3.0.0-49-gb606f0ab)\nSUSFS v2.0.0-CI-208dd1f"];

data=[
	[{text:"Disclosure v1.2.1",bg:"#fff",color:"#000"},{text:"Normal",bg:"#006600",color:"#fff"},{text:"Suspicious file (/system/addon.d)<br>Device spoofing<br>LineageOS in service list LineageOS in /system_ext/etc/selinux/system_ext_sepolicy.cil<br>Uname spoofing (DefaultDispatch)<br>Suspicious memory mapping (LineageOS)",bg:"#ff0000",color:"#fff"}],
	[{text:"Holmes v1.5.1",bg:"#fff",color:"#000"},{text:"Risky App (1)",bg:"#006600",color:"#fff"},{text:"CRASH before result",bg:"#000",color:"#fff"}],
